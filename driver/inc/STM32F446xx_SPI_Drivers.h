...
/*
 * this is handle structure for SPI pins
 */

typedef struct
{
	// pointer to the hold the base address of the SPI peripheral
	SPI_RegDef_t *pSPIx;  //this is hold the base address of the SPI port to which pin belong
	SPI_PinCofing_t SPI_PinCofing; //this hold GPIO pin configuration setting
...
#define SPI_EVENT_OVR_FLAG_CMPLT	3
